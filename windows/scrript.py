...
f1= open('C:\\Users\\geethika.d\\Desktop\\logs\\dmp\\auth.log', 'a')
...
f2= open('C:\\Users\\geethika.d\\Desktop\\logs\\dmp\\dkim.log', 'a')
#print(today,response_auth.text, file=f1)
...
f3= open('C:\\Users\\geethika.d\\Desktop\\logs\\dmp\\brand.log', 'a')
#print(today,response_auth.text, file=f1)
...
f4= open('C:\\Users\\geethika.d\\Desktop\\logs\\dmp\\dmarc.log', 'a')
#print(today,response_auth.text, file=f1)
...
f5= open('C:\\Users\\geethika.d\\Desktop\\logs\\dmp\\infra.log', 'a')
#print(today,response_auth.text, file=f1)
...
f6= open('C:\\Users\\geethika.d\\Desktop\\logs\\dmp\\new.log', 'a')
#print(today,response_auth.text, file=f1)
...
f7= open('C:\\Users\\geethika.d\\Desktop\\logs\\dmp\\sender.log', 'a')
#print(today,response_auth.text, file=f1)
...
f8= open('C:\\Users\\geethika.d\\Desktop\\logs\\dmp\\new_well.log', 'a')
#print(today,response_auth.text, file=f1)
...
f9= open('C:\\Users\\geethika.d\\Desktop\\logs\\dmp\\spf.log', 'a')
#print(today,response_auth.text, file=f1)
...
f10= open('C:\\Users\\geethika.d\\Desktop\\logs\\dmp\\threat.log', 'a')
#print(today,response_auth.text, file=f1)
...
f11= open('C:\\Users\\geethika.d\\Desktop\\logs\\dmp\\unauthorized.log', 'a')
#print(today,response_auth.text, file=f1)
...
f12=open('C:\\Users\\geethika.d\\Desktop\\logs\\appc\\appc.log', 'a')
